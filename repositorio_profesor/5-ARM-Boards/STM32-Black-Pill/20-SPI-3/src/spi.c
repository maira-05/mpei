...
void SPI_GPIO_Config(SPI_TypeDef *SPI){
    ...
    if(SPI==SPI3){
        ...
        WRITE_REG_FIELD(GPIOB->MODER,GPIO_MODER_MODER5,2); //SPI3_MOSI
        WRITE_REG_FIELD(GPIOB->AFR[0],GPIO_AFRL_AFRL5,6);
        WRITE_REG_FIELD(GPIOB->OSPEEDR,GPIO_OSPEEDER_OSPEEDR5,3);

        WRITE_REG_FIELD(GPIOB->MODER,GPIO_MODER_MODER4,2); //SPI3_MISO
        WRITE_REG_FIELD(GPIOB->AFR[0],GPIO_AFRL_AFRL4,6);
        WRITE_REG_FIELD(GPIOB->OSPEEDR,GPIO_OSPEEDER_OSPEEDR4,3);

        WRITE_REG_FIELD(GPIOB->MODER,GPIO_MODER_MODER3,2); //SPI3_SCk
        WRITE_REG_FIELD(GPIOB->AFR[0],GPIO_AFRL_AFRL3,6);
        WRITE_REG_FIELD(GPIOB->OSPEEDR,GPIO_OSPEEDER_OSPEEDR3,3);
    }
